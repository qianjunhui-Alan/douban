...
public class SubjectSpider {
    ...
    private static final String CL_URL =
            "https://fm.douban.com/j/v2/songlist/{0}/?kbps=192";
    ...
    private void getSubjectSongData(Subject subject) {
        ...
        final List<String> songIdList = songIds;
    ...
    private void getCollectionSongData(Subject subject) {
        String subjectId = subject.getId();
        String songDataUrl = MessageFormat.format(CL_URL, subjectId);

        // 替换为自己使用浏览器开发者工具观察到的值
        String cookie = "bid=tdprPACFYVQ; __utmv=30149280.22160; __gads=ID=dfefd17871c417a8:T=1597650157:S=ALNI_MaMxhr-A7y0_7nWfA92SbP8LLbxlg; gr_user_id=7aad110c-e14a-41a2-8f6f-a5889943a20b; _vwo_uuid_v2=D720C9E3AA5E4F9589344962FFCB667AC|85733030e9da62998c0f01ee204f1a9b; ll=\"118160\"; douban-profile-remind=1; __utma=30149280.1650612181.1597650126.1599354619.1601286840.18; __utmz=30149280.1601286840.18.12.utmcsr=accounts.douban.com|utmccn=(referral)|utmcmd=referral|utmcct=/; _ga=GA1.2.1650612181.1597650126; _pk_ref.100002.f71f=%5B%22%22%2C%22%22%2C1606990084%2C%22https%3A%2F%2Fham.youkeda.com%2F%22%5D; _pk_id.100002.f71f=4d9e833ad5488669.1606990084.1.1606990086.1606990084.; _gid=GA1.2.1946220461.1607429632";
        ...
        List<Map> songsData = (List<Map>)dataObj.get("songs");
        if (songsData == null || songsData.isEmpty()) {
            return;
        }
    ...
    private void getCollectionsData() {
        ...
        dataList.forEach(slObj ->{
            ...
            getCollectionSongData(collection);
        });
